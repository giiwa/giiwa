var CanvasParticle = (function(){
	...
	function canvasInit(canvasConfig){
		...
		var body = document.getElementById(canvasConfig.id);
		...
		var canvas = {
			...
			config: {
				...
				bgcolor: canvasConfig.bgcolor || "#2D2D2D",
				max_conn: 10
			}
		};
		...
		canvas.element.style = "position: fixed; top: 0; left: 0; z-index: -1; background:" + canvas.config.bgcolor;
		...
		canvas.element.onmouseleave = function(){
