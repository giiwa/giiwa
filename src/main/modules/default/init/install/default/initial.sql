...
alter table gi_node add globaltasks int; 
alter table gi_node add localthreads int; 
alter table gi_node add localpending int; 
alter table gi_node add localrunning int; 
