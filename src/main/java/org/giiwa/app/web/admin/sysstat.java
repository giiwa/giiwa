...
public class sysstat extends Model {
	...
	@Path(path = "cpu/list", login = true, access = "access.config.admin|access.system.admin")
	...
	@Path(path = "net/list", login = true, access = "access.config.admin|access.system.admin")
	...
	@Path(path = "disk/list", login = true, access = "access.config.admin|access.system.admin")
	...
	@Path(path = "netstat", login = true, access = "access.config.admin|access.system.admin")
	public void netstat() {
