...
public class appkey extends Model {
  ...
  public void history() {
    ...
    W q = W.create("module", Appkey.class.getName());
  ...
  public void create() {
    if (method.isPost()) {
      ...
      if (Appkey.create(appkey,
          V.create("appkey", appkey).copy(jo, "memo", "contact", "phone", "logout", "email")
              .set("setrule", this.getHtml("setrule")).set("getrule", this.getHtml("getrule"))
              .set("secret", UID.random(24))) > 0) {
  ...
  public void edit() {
    ...
    if (method.isPost()) {
      JSONObject jo = this.getJSON();
      V v = V.create().copy(jo, "memo", "secret", "contact", "phone", "logout", "email")
          .set("locked", "on".equals(this.getString("locked")) ? 1 : 0).set("setrule", this.getHtml("setrule"))
          .set("getrule", this.getHtml("getrule"));
