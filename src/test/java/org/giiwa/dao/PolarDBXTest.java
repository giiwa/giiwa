...
public class PolarDBXTest {
	...
	public void test() {
		...
		Helper.DBHelper helper = RDSHelper.create("jdbc:mysql://192.168.0.111:8527/dw?type=polardbx", "demo", "1231234", 10, null);
	...
	public void testUpdate() {
		...
		Helper.DBHelper helper = RDSHelper.create("jdbc:dm://192.168.0.42:5236/config", "demo", "1231231234", 10, null);
